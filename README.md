...
Данная ветка является фронтэндом.
Тут буду настройки внешнего вида страницы при регистрации и логировании.
Данные введения не входят в рамки учебного проекта и обучения.
